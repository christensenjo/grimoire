            ...
            <form class="space-y-4 md:space-y-6" action="#">
                ...
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="terms" aria-describedby="terms" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blood-800 dark:ring-offset-blood text-blood" required="">
                    </div>
                ...
                <p class="text-sm font-light text-gray-500 dark:text-tome-900">
                    Already have an account? <a href="#" class="font-medium text-primary-600 hover:underline dark:text-tome-900">Login here</a>
                </p>
            </form>
        </div>
    </div>
