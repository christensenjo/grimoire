            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <button
                        ...
                        type="button"
                        class="inline-flex items-center p-2 ml-1 text-sm text-fortress rounded-lg lg:hidden hover:bg-parchment-100 focus:outline-none focus:ring-2 focus:ring-parchment-100 dark:text-fortress dark:hover:bg-gray-700 dark:focus:ring-gray-600"
